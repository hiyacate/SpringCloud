...
SERVICE_NAME=eureka.jar
SERVICE_PORT=8761
LOGGING_PATH=/Users/hiya/log/eureka
JVM_LOG_DIR=/Users/hiya/log/eureka/jvm
...
nohup java -server -Xmx1G -Xms1G \
 -XX:+UseG1GC \
 -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=$JVM_LOG_DIR -XX:ErrorFile=$JVM_LOG_DIR/eureka_err_pid%p.log \
 -Dhost.name=$HOSTNAME \
 -DAPP_HOME=$DIR \
